...
public class Library
{
    ...
    public void Init(ref InkCanvas display, ref ComboBox size, ref ComboBox colour)
    {
        ...
        float a = HeartBeatPage.SetBrushSize(10);
        System.Diagnostics.Debug.WriteLine("LOOK HERE: " + a);
        //string selectedSize = ((ComboBoxItem)size.SelectedItem).Tag.ToString();
        string selectedSize = (a.ToString());
        ...
        attributes.PenTipTransform = System.Numerics.Matrix3x2.CreateRotation((float)Math.PI / 4);
        attributes.Size = new Size(a, a);
    ...
    /*public async void Bluetooth(object sender, RoutedEventArgs e)
    {
